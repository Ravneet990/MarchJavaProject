...
public class StringDemo {
	...
	public static void main(String[] args) {
		...
		String[] nameArray1 = firstAndLastName.split(" ");

		System.out.println("First Name:" + nameArray1[0]);
		System.out.println("Last Name:" + nameArray1[1]);
		...
		String[] splitStringToArray1 = splitAString.split("&");

		System.out.println(Arrays.toString(splitStringToArray1));

		String[] splitExample = splitAString.split("string");

		String[] splitExample1 = splitAString.split("string");
		System.out.println(Arrays.toString(splitExample1));
